...
@section('page-subtitle', 'Modifier la facture client')
...
@section('content')
    ...
    <div class="breadcrumb">
        ...
        <span class="breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></span>
        <span>Edit facture</span>
    </div>

    <form method="POST" action="{{ route('factures.update', $facture) }}" id="factureForm">
        @csrf
        @method('PATCH')
        <div class="form-layout">
            ...
            <div class="form-section">
                        ...
                        <div class="field">
                            ...
                            <div class="field-input-wrap">
                                ...
                                <input type="text" id="num_facture" name="num_facture"
                                    ...
                                    value="{{ old('num_facture', $facture->num_facture) }}" placeholder="Ex : FAC-2024-001"
                                ...
                                <select id="client_id" name="client_id"
                                    ...
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}" data-type="{{ $client->type }}"
                                            {{ old('client_id', $facture->client->id) == $client->id ? 'selected' : '' }}>
                                            {{ $client->nom }}
                        ...
                        <div class="field">
                            ...
                            <div class="field-input-wrap">
                                ...
                                <input type="date" id="date_facture" name="date_facture"
                                    ...
                                    value="{{ old('date_facture', $facture->date_facture->format('Y-m-d')) }}" required>
                            </div>
                            @error('date_facture')
                                <span class="field-error"><i class="fa-solid fa-circle-exclamation"></i>
                                    {{ $message }}</span>
                        ...
                        <div class="field">
                            ...
                            <div class="field-input-wrap">
                                ...
                                <input type="number" id="total_ht" name="total_ht"
                                    ...
                                    value="{{ old('total_ht', $facture->total_ht) }}" step="0.01" min="0"
                                    required>
                            </div>
                            @error('total_ht')
                                <span class="field-error"><i class="fa-solid fa-circle-exclamation"></i>
                        ...
                        <div class="field">
                            ...
                            <div class="field-input-wrap">
                                ...
                                <input type="number" id="total_tva" name="total_tva"
                                    ...
                                    value="{{ old('total_tva', $facture->total_tva) }}" step="0.01" min="0" required>
                            </div>
                            @error('total_tva')
                                <span class="field-error"><i class="fa-solid fa-circle-exclamation"></i>
                                    {{ $message }}</span>
                ...
                <div class="section-card">
                    ...
                    <input type="hidden" id="statut" name="statut" value="{{ old('statut', $facture->statut) }}">
