            ...
            <div class="form-section">
                ...
                <div class="section-card">
                    ...
                    <div class="field">
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Ce rôle permet de…">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="field-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="permissions-card">
                    ...
                    {{--
            ════════════════════════════════════════════════
            POUR AJOUTER UN GROUPE DE PERMISSIONS :
              1. Copier un bloc .perm-group complet
              2. Changer : data-group, l'icône, le titre, les checkboxes (name + label)
            ════════════════════════════════════════════════
            --}}
                            ...
                            <div class="perm-group-header" data-group="{{ $module }}">
                                ...
                                <div style="display:flex;align-items:center;gap:10px">
                                    <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                                        <input type="checkbox" class="group-toggle" data-group="{{ $module }}">
                                ...
                                @foreach ($permissions as $permission)
                                    ...
                                    <label class="perm-item">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}"
                                            class="perm-check" data-group="{{ $module }}">
                                        <span
                    ...
                    {{-- ── Groupe : Véhicules ── --}}
                    {{-- <div class="perm-group">
                <div class="perm-group-header" data-group="vehicules">
                    <div class="perm-group-header-left">
                        <div class="perm-group-icon"><i class="fa-solid fa-truck"></i></div>
                        <span class="perm-group-name">Véhicules</span>
                        <span class="perm-group-badge" id="badge-vehicules">0 / 5</span>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px">
                        <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                            <input type="checkbox" class="group-toggle" data-group="vehicules">
                            <span class="toggle-track"><span class="toggle-thumb"></span></span>
                        </label>
                        <i class="fa-solid fa-chevron-down perm-chevron"></i>
                    </div>
                </div>
                <div class="perm-list" id="list-vehicules">
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="vehicules.index" class="perm-check" data-group="vehicules">
                        <span class="perm-item-label">Voir les véhicules</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="vehicules.show" class="perm-check" data-group="vehicules">
                        <span class="perm-item-label">Voir détail véhicule</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="vehicules.create" class="perm-check" data-group="vehicules">
                        <span class="perm-item-label">Ajouter un véhicule</span>
                        <span class="perm-item-desc">Création</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="vehicules.edit" class="perm-check" data-group="vehicules">
                        <span class="perm-item-label">Modifier un véhicule</span>
                        <span class="perm-item-desc">Édition</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="vehicules.delete" class="perm-check" data-group="vehicules">
                        <span class="perm-item-label">Supprimer un véhicule</span>
                        <span class="perm-item-desc">Suppression définitive</span>
                    </label>
                </div>
            </div> --}}
                    ...
                    {{-- ── Groupe : Chauffeurs ── --}}
                    {{-- <div class="perm-group">
                <div class="perm-group-header" data-group="chauffeurs">
                    <div class="perm-group-header-left">
                        <div class="perm-group-icon"><i class="fa-solid fa-id-card"></i></div>
                        <span class="perm-group-name">Chauffeurs</span>
                        <span class="perm-group-badge" id="badge-chauffeurs">0 / 5</span>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px">
                        <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                            <input type="checkbox" class="group-toggle" data-group="chauffeurs">
                            <span class="toggle-track"><span class="toggle-thumb"></span></span>
                        </label>
                        <i class="fa-solid fa-chevron-down perm-chevron"></i>
                    </div>
                </div>
                <div class="perm-list" id="list-chauffeurs">
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="chauffeurs.index" class="perm-check" data-group="chauffeurs">
                        <span class="perm-item-label">Voir les chauffeurs</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="chauffeurs.show" class="perm-check" data-group="chauffeurs">
                        <span class="perm-item-label">Voir détail chauffeur</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="chauffeurs.create" class="perm-check" data-group="chauffeurs">
                        <span class="perm-item-label">Ajouter un chauffeur</span>
                        <span class="perm-item-desc">Création</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="chauffeurs.edit" class="perm-check" data-group="chauffeurs">
                        <span class="perm-item-label">Modifier un chauffeur</span>
                        <span class="perm-item-desc">Édition</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="chauffeurs.delete" class="perm-check" data-group="chauffeurs">
                        <span class="perm-item-label">Supprimer un chauffeur</span>
                        <span class="perm-item-desc">Suppression définitive</span>
                    </label>
                </div>
            </div> --}}
                    ...
                    {{-- ── Groupe : Commandes ── --}}
                    {{-- <div class="perm-group">
                <div class="perm-group-header" data-group="commandes">
                    <div class="perm-group-header-left">
                        <div class="perm-group-icon"><i class="fa-solid fa-plus"></i></div>
                        <span class="perm-group-name">Commandes</span>
                        <span class="perm-group-badge" id="badge-commandes">0 / 5</span>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px">
                        <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                            <input type="checkbox" class="group-toggle" data-group="commandes">
                            <span class="toggle-track"><span class="toggle-thumb"></span></span>
                        </label>
                        <i class="fa-solid fa-chevron-down perm-chevron"></i>
                    </div>
                </div>
                <div class="perm-list" id="list-commandes">
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="commandes.index" class="perm-check" data-group="commandes">
                        <span class="perm-item-label">Voir les commandes</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="commandes.show" class="perm-check" data-group="commandes">
                        <span class="perm-item-label">Voir détail commande</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="commandes.create" class="perm-check" data-group="commandes">
                        <span class="perm-item-label">Créer une commande</span>
                        <span class="perm-item-desc">Création</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="commandes.edit" class="perm-check" data-group="commandes">
                        <span class="perm-item-label">Modifier une commande</span>
                        <span class="perm-item-desc">Édition</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="commandes.delete" class="perm-check" data-group="commandes">
                        <span class="perm-item-label">Supprimer une commande</span>
                        <span class="perm-item-desc">Suppression définitive</span>
                    </label>
                </div>
            </div> --}}
                    ...
                    {{-- ── Groupe : Facturation ── --}}
                    {{-- <div class="perm-group">
                <div class="perm-group-header" data-group="facturation">
                    <div class="perm-group-header-left">
                        <div class="perm-group-icon"><i class="fa-solid fa-file-invoice-dollar"></i></div>
                        <span class="perm-group-name">Facturation</span>
                        <span class="perm-group-badge" id="badge-facturation">0 / 5</span>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px">
                        <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                            <input type="checkbox" class="group-toggle" data-group="facturation">
                            <span class="toggle-track"><span class="toggle-thumb"></span></span>
                        </label>
                        <i class="fa-solid fa-chevron-down perm-chevron"></i>
                    </div>
                </div>
                <div class="perm-list" id="list-facturation">
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="facturation.index" class="perm-check" data-group="facturation">
                        <span class="perm-item-label">Voir les factures</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="factures.show" class="perm-check" data-group="facturation">
                        <span class="perm-item-label">Voir détail facture</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="factures.create" class="perm-check" data-group="facturation">
                        <span class="perm-item-label">Créer une facture</span>
                        <span class="perm-item-desc">Création</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="facturation.edit" class="perm-check" data-group="facturation">
                        <span class="perm-item-label">Modifier les factures</span>
                        <span class="perm-item-desc">Edit</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="facturation.delete" class="perm-check" data-group="facturation">
                        <span class="perm-item-label">Supprimer les factures</span>
                        <span class="perm-item-desc">Delete</span>
                    </label>
                </div>
            </div> --}}
                    ...
                    {{-- ── Groupe : users ── --}}
                    {{-- <div class="perm-group">
                <div class="perm-group-header" data-group="users">
                    <div class="perm-group-header-left">
                        <div class="perm-group-icon"><i class="fa-solid fa-user-gear"></i></div>
                        <span class="perm-group-name">users</span>
                        <span class="perm-group-badge" id="badge-users">0 / 5</span>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px">
                        <label class="perm-group-toggle" title="Tout cocher" onclick="event.stopPropagation()">
                            <input type="checkbox" class="group-toggle" data-group="users">
                            <span class="toggle-track"><span class="toggle-thumb"></span></span>
                        </label>
                        <i class="fa-solid fa-chevron-down perm-chevron"></i>
                    </div>
                </div>
                <div class="perm-list" id="list-users">
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="users.index" class="perm-check" data-group="users">
                        <span class="perm-item-label">voir les utilisateurs</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="users.show" class="perm-check" data-group="users">
                        <span class="perm-item-label">voir détail utilisateur</span>
                        <span class="perm-item-desc">Lecture seule</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="users.create" class="perm-check" data-group="users">
                        <span class="perm-item-label">Créer Utilisateur</span>
                        <span class="perm-item-desc">Création des utilisateurs</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="users.edit" class="perm-check" data-group="users">
                        <span class="perm-item-label">Modifier Utilisateur</span>
                        <span class="perm-item-desc">Modifier Utilisateur</span>
                    </label>
                    <label class="perm-item">
                        <input type="checkbox" name="permissions[]" value="users.delete" class="perm-check" data-group="users">
                        <span class="perm-item-label">Supprimer Utilisateur</span>
                        <span class="perm-item-desc">Supprimer Utilisateur</span>
                    </label>
                </div>
            </div> --}}
